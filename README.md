# Functional Python [![](https://github.com/zlin22-arch/functional-python/workflows/tests/badge.svg)](https://github.com/zlin22-arch/functional-python/actions?query=workflow%3Atests)
